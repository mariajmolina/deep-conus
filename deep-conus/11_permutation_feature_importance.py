...
class PermutationFeatureImportance:
    ...
    """Class instantiation of PermutationFeatureImportance:
            
    Conduct a permutation feature importance analysis, which can be summarized in the following steps:
    
    1- retrain with one variable shuffled at a time.
    2- recompute error
    ...
    Attributes:
        ...
        variable_to_shuffle (int): Index of the input variable to shuffle.
    ...
    def __init__(self, working_directory, dlfile_directory, variables, variable_to_shuffle, model_num, 
        ...
        self.variable_to_shuffle=variable_to_shuffle
