...
def grab_onerand_patches(variable, error_metrics, random_number):
    ...
    for c, (a, b) in enumerate(zip(filt_auc_top_rand, filt_auc_top_indx)):
        ...
        originals_auc_top[c] = data.fn_indx.astype('int').values
        originals_auc_top_preshuf[c] = data.orig_indx.astype('int').values[data.fn_indx.astype('int').values]
    ...
    for c, (a, b) in enumerate(zip(filt_auc_bot_rand, filt_auc_bot_indx)):
        path = f'{future_dl_models}/comppfi_results_nomask_model25_random{int(a)}_pfivar{variable}_perm{b}.nc'
        data = xr.open_dataset(path)
        originals_auc_bot[c] = data.fn_indx.astype('int').values
        originals_auc_bot_preshuf[c] = data.orig_indx.astype('int').values[data.fn_indx.astype('int').values]
    ...
    for c, (a, b) in enumerate(zip(filt_csi_top_rand, filt_csi_top_indx)):
        path = f'{future_dl_models}/comppfi_results_nomask_model25_random{int(a)}_pfivar{variable}_perm{b}.nc'
        data = xr.open_dataset(path)
        originals_csi_top[c] = data.fn_indx.astype('int').values
        originals_csi_top_preshuf[c] = data.orig_indx.astype('int').values[data.fn_indx.astype('int').values]
    ...
    for c, (a, b) in enumerate(zip(filt_csi_bot_rand, filt_csi_bot_indx)):
        path = f'{future_dl_models}/comppfi_results_nomask_model25_random{int(a)}_pfivar{variable}_perm{b}.nc'
        data = xr.open_dataset(path)
        originals_csi_bot[c] = data.fn_indx.astype('int').values
        originals_csi_bot_preshuf[c] = data.orig_indx.astype('int').values[data.fn_indx.astype('int').values]
    ...
    for c, (a, b) in enumerate(zip(filt_auc_mid_rand, filt_auc_mid_indx)):
        path = f'{future_dl_models}/comppfi_results_nomask_model25_random{int(a)}_pfivar{variable}_perm{b}.nc'
        data = xr.open_dataset(path)
        originals_auc_mid[c] = data.fn_indx.astype('int').values
        originals_auc_mid_preshuf[c] = data.orig_indx.astype('int').values[data.fn_indx.astype('int').values]
    ...
    for c, (a, b) in enumerate(zip(filt_csi_mid_rand, filt_csi_mid_indx)):
        path = f'{future_dl_models}/comppfi_results_nomask_model25_random{int(a)}_pfivar{variable}_perm{b}.nc'
        data = xr.open_dataset(path)
        originals_csi_mid[c] = data.fn_indx.astype('int').values
        originals_csi_mid_preshuf[c] = data.orig_indx.astype('int').values[data.fn_indx.astype('int').values]
    ...
    for c, (a, b) in enumerate(zip(filt_bss_top_rand, filt_bss_top_indx)):
        path = f'{future_dl_models}/comppfi_results_nomask_model25_random{int(a)}_pfivar{variable}_perm{b}.nc'
        data = xr.open_dataset(path)
        originals_bss_top[c] = data.fn_indx.astype('int').values
        originals_bss_top_preshuf[c] = data.orig_indx.astype('int').values[data.fn_indx.astype('int').values]
    ...
    for c, (a, b) in enumerate(zip(filt_bss_bot_rand, filt_bss_bot_indx)):
        path = f'{future_dl_models}/comppfi_results_nomask_model25_random{int(a)}_pfivar{variable}_perm{b}.nc'
        data = xr.open_dataset(path)
        originals_bss_bot[c] = data.fn_indx.astype('int').values
        originals_bss_bot_preshuf[c] = data.orig_indx.astype('int').values[data.fn_indx.astype('int').values]
    ...
    for c, (a, b) in enumerate(zip(filt_bss_mid_rand, filt_bss_mid_indx)):
        path = f'{future_dl_models}/comppfi_results_nomask_model25_random{int(a)}_pfivar{variable}_perm{b}.nc'
        data = xr.open_dataset(path)
        originals_bss_mid[c] = data.fn_indx.astype('int').values
        originals_bss_mid_preshuf[c] = data.orig_indx.astype('int').values[data.fn_indx.astype('int').values]
    ...
    data = xr.open_dataset(path)
    originals_results = data.tp_indx.astype('int').values
